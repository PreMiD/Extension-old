    ...
    <div class="inline">
      ...
      <div v-bind:class="{hidden: this.connected}" v-if="!this.connected">
        <div id="error">
          ...
          <a draggable="false" target="_blank" href="https://wiki.premid.app/troubleshooting/troubleshooting"><i class="fas fa-question"></i> {{$t('tab.installed.link.troubleshooting')}}</a>
